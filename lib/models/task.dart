// Central domain model for tasks. Uses `freezed` for immutable data classes
// with built-in copyWith, pattern matching, and equality — essential for
// Riverpod's state comparison on rebuild.
//
// Priority is stored as a raw 1-10 integer in Firestore (for efficient
// querying/filtering) and mapped to the three-tier [TaskPriority] enum
// only for display/colorization. Subtasks are embedded as a list of
// [SubTask] rather than a separate collection to avoid N+1 reads.
