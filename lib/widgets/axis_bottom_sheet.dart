// Reusable bottom-sheet shell used by every modal in the app.
// Provides a consistent surface, drag handle, title row with close button,
// and optional action widgets. [AxisConfirmationSheet] specialises this
// for yes/no confirmation with cancel/confirm buttons.
//
// Data flow: sheets return their result via [Navigator.pop] — the caller
// (e.g. [HomeScreen._showTaskDetail]) awaits the pop value and writes it
// back to the repository. This keeps the sheet itself stateless and
// testable.
//
// [AxisBottomSheetExtension] adds a convenience `.showAxisBottomSheet()`
// extension on [BuildContext] for callers that don't need the static method.
