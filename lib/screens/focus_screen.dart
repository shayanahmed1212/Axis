// Pomodoro timer screen with a circular progress ring (drawn via
// [CustomPainter]), a weekly bar chart, and a mocked app-usage list.
//
// The timer runs in [FocusTimerNotifier] (an in-memory [StateNotifier])
// and on completion triggers a [FocusSession] save to Firestore followed
// by a completion dialog. The weekly chart and app usage data come from
// [focusSessionStateProvider] which merges the live timer, historical
// session stream, and mocked usage stream into a single state object.
...
import 'package:axis/services/focus_service.dart';
