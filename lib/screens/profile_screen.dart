// Profile screen showing user avatar, task stats pills, and grouped
// settings/account actions. Data flows:
//   - Avatar photo stored as base64 data URI in Firestore via [StorageService]
//   - Display name and password updates go through [authControllerProvider]
//   - Category management opens [CategoriesScreen] via a custom picker
//   - Logout calls [AuthController.signOut] with a confirmation dialog
...
import 'package:axis/services/storage_service.dart';
