// Registration form with name/email/password/confirm fields.
// On success the router's `redirect` guard catches the new auth state and
// navigates to the onboarding flow automatically — so we explicitly
// navigate here to `/onboarding` only as a fallback for the timing gap
// between the Firebase create call and the auth state listener firing.
